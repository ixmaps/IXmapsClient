...
var request = require('request'), net = require('net'), dns = require('dns'), _ = require('lodash'), async = require('async'),
...
exports.doTrace = function(options, send) {
  ...
  function submitTrace(err, results) {
    ...
    request.post(SUBMIT_URI, {form: submission}, function(err, res, body) {
