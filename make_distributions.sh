...
MODS="lodash open async cheerio express open raw-socket2 request socket.io"
...
for i in linux ixmaps-darwin win32 win64 ; do
  ...
  # socket.io weirdness
  if [ ! -d dist/$i/node_modules/socket.io/node_modules/socket.io-client ]; then rsync -a node_modules/socket.io-client dist/$i/node_modules/socket.io/node_modules/socket.io-client; fi
  for f in $BASE; do
